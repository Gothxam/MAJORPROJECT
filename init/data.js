// 44.3. Sample data for DB
const sampleListings = [  //data stored in the form array, (array of js objects)
...
module.exports = { data: sampleListings };  //data = export in the form an object
                // key : value